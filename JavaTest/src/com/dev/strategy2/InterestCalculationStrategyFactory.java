...
public class InterestCalculationStrategyFactory {
	...
	// A factory can create a new instance of a class for each request, but
	// since our calculation strategies are stateless,
	// we can hang on to a single instance of each strategy and return that
