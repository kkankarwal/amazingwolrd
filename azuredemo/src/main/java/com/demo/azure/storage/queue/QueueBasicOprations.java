package com.demo.azure.storage.queue;
 ...
 * CloudQueueClient.
 */
public class QueueBasicOprations {
	...
	public static void main(String[] args) throws InvalidKeyException, URISyntaxException {
		...
		try {
			 ...
			 * 
			 * // Create messages and add it to the queue CloudQueueMessage
			 * message1 = new CloudQueueMessage("Hello, World1");
			 * queue.addMessage(message1);
			 * 
			 * CloudQueueMessage message2 = new CloudQueueMessage(
			 * "Hello, World2"); queue.addMessage(message2);
			 * 
			 * CloudQueueMessage message3 = new CloudQueueMessage(
			 * "Hello, World3"); queue.addMessage(message3);
			 * 
			 * CloudQueueMessage message4 = new CloudQueueMessage(
			 * "Hello, World4"); queue.addMessage(message4);
			 * 
			 * CloudQueueMessage message5 = new CloudQueueMessage(
			 * "Hello, World5"); queue.addMessage(message5);
			 */
			// Peek at the next message
			CloudQueueMessage peekedMessage = queue.peekMessage();
			System.out.println(String.format("Peeked Message : %s", peekedMessage.getMessageContentAsString()));
			/*
			 * // Modify the message content and set it to be visible
			 * immediately // Retrieve the first visible message in the queue
